    ...
    <section className="max-w-7xl mx-auto">
      ...
      <div className="mt-10">
        <p className="mt-2 text-[#666e75] text-[14px]">
          One you created the image you want, you can share it with others in
          the comunity
        </p>
        <button
          onClick={share}
          className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-s w-full sm:w-auto px-5 py-2.5 text-center"
        >
