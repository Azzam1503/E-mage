  ...
  const generateImage = async () => {
    if(form.prompt){
      try {
        ...
        const response = await fetch("https://img-generator-git-main-azzam1503.vercel.app/api/v1/dalle", 
        {
          method: 'POST',
          headers: {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className='mt-2 text-[#666e75] text-[14px]'>One you created the image you want, you can share it with others in the comunity</p>
          <button type='submit' className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-s w-full sm:w-auto px-5 py-2.5 text-center">
